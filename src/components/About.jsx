...
export const About = () => {
  return (
    <PageTransition>
      <section className="bg-slate-950 text-white py-2 px-4 sm:px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div>
              ...
              <p className="text-gray-300 leading-relaxed mb-5">
                ...
                CSS, Node.js, Express.js, MongoDB, Zustand, and React Query.
                I enjoy turning complex problems into simple and intuitive user
                experiences.
              </p>
